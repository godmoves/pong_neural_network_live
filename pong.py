...
def drawPaddle1(paddle1YPos):
    # crreate it
    paddle1 = pygame.Rect(PADDLE_BUFFER, paddle1YPos,
...
def drawPaddle2(paddle2YPos):
    ...
    paddle2 = pygame.Rect(WINDOW_WIDTH - PADDLE_BUFFER -
                          PADDLE_WIDTH, paddle2YPos, PADDLE_WIDTH, PADDLE_HEIGHT)
    # draw it
...
class PongGame:
    ...
    def getNextFrame(self, action):
        ...
        [score, self.paddle1YPos, self.paddle2YPos, self.ballXPos, self.ballYPos, self.ballXDirection, self.ballYDirection] = updateBall(
